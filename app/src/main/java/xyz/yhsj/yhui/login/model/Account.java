package xyz.yhsj.yhui.login.model;
...
public class Account {
    ...
    public String getLocationhz() {
        return this.locationhz;
    }

    public void setLocationhz(String locationhz) {
        this.locationhz = locationhz;
    }
